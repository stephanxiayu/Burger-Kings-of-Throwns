...
import 'package:burgerking_apitest/Screen/StephansKings/DetailPage.dart';
import 'package:shimmer/shimmer.dart';

class StephanHomeScreen extends StatefulWidget {
  const StephanHomeScreen({super.key});

  @override
  State<StephanHomeScreen> createState() => _StephanHomeScreenState();
}

class _StephanHomeScreenState extends State<StephanHomeScreen> {
