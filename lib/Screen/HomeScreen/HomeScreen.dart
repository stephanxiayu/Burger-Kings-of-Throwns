...
bool listContainsCharacter(List<CharacterModel> list, CharacterModel character) {
  ...
  fetchData() async {
    ...
    setState(() {
      ...
      for (int i = 0; i < data!.length; i++) {
        _swipeItems.add(
          SwipeItem(
          content: Content(text: data![i].fullName, imageUrl: data![i].imageUrl),
         likeAction: () {
  setState(()async {
    actionMessage = "LIKE";
...
superlikeAction: ()async {
  ...
  children: [
    ...
    Image.network(
      ...
      height: screenHeight * 3/3, // This makes it full screen height, adjust accordingly
      fit: BoxFit.cover,
    ),
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            stops: [0.8, 1.0],  // this will make gradient start at 80% from top and end at the bottom
          ),
        ),
      ),
    ),
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: actionMessage == "LIKE" 
                  ...
                  : actionMessage == "NOPE" 
                      ? Colors.red 
                      : Colors.blue, // default to blue for SUPERLIKE
